...
Pod::Spec.new do |s|
  s.name             = 'LiuCategores'
  s.version          = '0.1.0'
  s.summary          = 'A short description of LiuCategores.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/liukkk333/LiuCategores'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'liukkk333' => 'liuk@izkml.com' }
  s.source           = { :git => 'https://github.com/liukkk333/LiuCategores.git', :tag => s.version.to_s }
